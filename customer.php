...
<body >
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark ">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      <a class="navbar-brand" href="#">Hostal Carolinas</a>
      <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
        <li class="nav-item active">
          <a class="nav-link" href="#">Inicio <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#room">Habitaciones</a>
        </li>
        <li class="nav-item">
  ...
  <!-- Text -->
  <section id="text">
    <p class="text-1">Bienvenido a Juayua</p>
    <p class="text-2">Un lugar asombroso para estar</p>
  </section>
...
?>
    ...
    <div class="container" id="room">
        <div class="row">
          ...
          <div class="col-sm">
          <p class="price"><?php echo $row["amount"] ?>/- Por Dia</p>
          <p class="text"><?php echo $row["room_name"] ?> Room</p>
          <?php $conn->close(); ?>
            <!-- <input class="book-button" type="button" value="Reserva Ahora" name="book" onclick="openForm()"> -->
            <!-- Button trigger modal -->
            <button onclick="location.href='register.php'" type="button" class="book-button">Reserva Ahora</button>
          </div>
        </div>
      </div>
      </form>
